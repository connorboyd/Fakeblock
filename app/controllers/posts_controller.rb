class PostsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @post.save
        format.html { redirect_to "/profile?id=#{@post.on_wall_of_user}", notice: 'Post was successfully created.' }
...
def delete
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:post_id, :user_id, :time_posted, :status, :on_wall_of_user)
    end
end
