...
class UserInfosControllerTest < ActionController::TestCase
  ...
  test "should create user_info" do
    assert_difference('UserInfo.count') do
      post :create, user_info: { birthday: @user_info.birthday, hometown: @user_info.hometown, job: @user_info.job, quotes: @user_info.quotes, school: @user_info.school, user_id: @user_info.user_id }
    end
  ...
  test "should update user_info" do
    patch :update, id: @user_info, user_info: { birthday: @user_info.birthday, hometown: @user_info.hometown, job: @user_info.job, quotes: @user_info.quotes, school: @user_info.school, user_id: @user_info.user_id }
    assert_redirected_to user_info_path(assigns(:user_info))
  end
